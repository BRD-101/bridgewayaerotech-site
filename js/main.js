...
(function() {
  ...
  // Landing shows the featured weekly editorial plus the top news articles
  // by relevance score. Section and nav links stay hidden until content exists.
  ...
  function renderInsightCards(posts, count) {
    ...
    posts.slice(0, count || 6).forEach(function(post, i) {
      var card = document.createElement('article');
      card.className = 'insight-card reveal' + (i % 3 > 0 ? ' reveal-delay-' + (i % 3) : '');
